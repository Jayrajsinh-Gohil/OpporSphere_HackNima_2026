...
STUDENTS_SEED_DATA = [
    ...
    # ── AI Background Students (8) ──
    {
        "name": "Aryan Varma",
        "email": "aryan.varma@example.edu",
        "department": "Artificial Intelligence & Machine Learning",
        "location": "Bengaluru, Karnataka",
        "skills": ["LangChain", "LlamaIndex", "AutoGen", "Python", "Vector Databases", "Prompt Engineering"],
        "interests": ["Generative AI", "Autonomous Agents", "RAG Architectures"],
        "career_goals": "Found an enterprise AI startup creating autonomous multi-agent software engineering workforces.",
    },
    {
        "name": "Tanya Roy",
        "email": "tanya.roy@example.edu",
        "department": "Computer Science & Vision Computing",
        "location": "Hyderabad, Telangana",
        "skills": ["PyTorch", "OpenCV", "YOLOv10", "Computer Vision", "TensorRT", "Python"],
        "interests": ["Real-time Object Tracking", "Edge Vision", "Autonomous Drones"],
        "career_goals": "Build ultra-fast computer vision models deployed on embedded drone platforms.",
    },
    {
        "name": "Suresh Nambiar",
        "email": "suresh.nambiar@example.edu",
        "department": "Data Science & MLOps",
        "location": "Chennai, Tamil Nadu",
        "skills": ["MLOps", "Kubeflow", "MLflow", "Triton Inference Server", "Docker", "FastAPI", "Python"],
        "interests": ["Model Monitoring", "Inference Optimization", "Distributed Training"],
        "career_goals": "Lead MLOps infrastructure scaling LLM inference pipelines with sub-50ms latency.",
    },
    {
        "name": "Riddhi Trivedi",
        "email": "riddhi.trivedi@example.edu",
        "department": "Artificial Intelligence & Robotics",
        "location": "Ahmedabad, Gujarat",
        "skills": ["Multimodal AI", "Diffusion Models", "Vision-Language Models", "CLIP", "PyTorch", "Transformers"],
        "interests": ["Generative Media", "Robotics Vision", "Synthetic Data"],
        "career_goals": "Pioneer multimodal vision-language models for robotic scene understanding in manufacturing.",
    },
    {
        "name": "Faizan Malik",
        "email": "faizan.malik@example.edu",
        "department": "Computational Linguistics & Computer Science",
        "location": "Pune, Maharashtra",
        "skills": ["NLP", "Hugging Face", "Tokenizers", "IndicBERT", "PyTorch", "Speech-to-Text"],
        "interests": ["Multilingual AI", "Low-Resource Languages", "Speech Processing"],
        "career_goals": "Develop high-accuracy NLP and translation systems for Indian regional languages.",
    },
    {
        "name": "Shalini Saxena",
        "email": "shalini.saxena@example.edu",
        "department": "Cognitive Science & Artificial Intelligence",
        "location": "Noida, Uttar Pradesh",
        "skills": ["Deep Learning", "Reinforcement Learning", "Gymnasium", "Jax", "PyTorch", "Python"],
        "interests": ["Decision Intelligence", "Game Theory", "Multi-Agent Simulation"],
        "career_goals": "Conduct breakthrough research in cooperative multi-agent reinforcement learning.",
    },
    {
        "name": "Aarohi Sengupta",
        "email": "aarohi.sengupta@example.edu",
        "department": "Biomedical Engineering & AI",
        "location": "Kolkata, West Bengal",
        "skills": ["MONAI", "PyTorch", "Medical Imaging", "DICOM", "Python", "Biostatistics"],
        "interests": ["Computational Healthcare", "Cancer Radiomics", "Clinical Decision Support"],
        "career_goals": "Deploy clinically validated AI tools that assist radiologists in early cancer detection.",
    },
    {
        "name": "Karan Singhal",
        "email": "karan.singhal@example.edu",
        "department": "Computer Science & Engineering",
        "location": "Jaipur, Rajasthan",
        "skills": ["LLM Fine-Tuning", "LoRA", "QLoRA", "vLLM", "llama.cpp", "Python", "CUDA"],
        "interests": ["Model Quantization", "Local LLMs", "GPU Acceleration"],
        "career_goals": "Optimize open-source foundation models to run efficiently on consumer hardware.",
    },

    # ── Web & Software Development Students (9) ──
    {
        "name": "Chirag Bhatt",
        "email": "chirag.bhatt@example.edu",
        "department": "Information Technology",
        "location": "Surat, Gujarat",
        "skills": ["Next.js", "React", "TypeScript", "Tailwind CSS", "Prisma", "PostgreSQL"],
        "interests": ["Full Stack Web", "Server Components", "SaaS Architecture"],
        "career_goals": "Build scalable B2B web applications serving thousands of concurrent users.",
    },
    {
        "name": "Pranav Kulkarni",
        "email": "pranav.kulkarni@example.edu",
        "department": "Computer Engineering",
        "location": "Pune, Maharashtra",
        "skills": ["Golang", "gRPC", "Kafka", "PostgreSQL", "Docker", "Kubernetes", "Redis"],
        "interests": ["High-Scale Backends", "Distributed Systems", "Message Queues"],
        "career_goals": "Design fault-tolerant distributed transaction systems for fintech infrastructure.",
    },
    {
        "name": "Aniket Rawat",
        "email": "aniket.rawat@example.edu",
        "department": "Computer Science & Engineering",
        "location": "Indore, Madhya Pradesh",
        "skills": ["Java", "Spring Boot", "Hibernate", "MySQL", "Elasticsearch", "Microservices"],
        "interests": ["Enterprise Architecture", "Search Systems", "Cloud Backends"],
        "career_goals": "Architect enterprise cloud platforms that process millions of transactions per day.",
    },
    {
        "name": "Mansi Sharma",
        "email": "mansi.sharma@example.edu",
        "department": "Computer Applications",
        "location": "Chandigarh",
        "skills": ["Vue.js", "Nuxt.js", "Three.js", "WebGL", "Tailwind CSS", "GSAP", "TypeScript"],
        "interests": ["Creative Web Development", "3D Web Experiences", "Interactive Storytelling"],
        "career_goals": "Build award-winning interactive digital products and 3D web visualizations.",
    },
    {
        "name": "Deepak Reddy",
        "email": "deepak.reddy@example.edu",
        "department": "Information Systems",
        "location": "Hyderabad, Telangana",
        "skills": ["Node.js", "Express", "React", "Socket.io", "MongoDB", "Redis", "JavaScript"],
        "interests": ["Real-time Collaboration", "WebSockets", "Multiplayer Apps"],
        "career_goals": "Engineer collaborative workspace apps with zero-latency synchronization.",
    },
    {
        "name": "Harsh Vardhan",
        "email": "harsh.vardhan@example.edu",
        "department": "Software Systems",
        "location": "Lucknow, Uttar Pradesh",
        "skills": ["Python", "FastAPI", "AsyncIO", "Celery", "PostgreSQL", "Docker"],
        "interests": ["Asynchronous Architecture", "API Design", "High Throughput"],
        "career_goals": "Lead backend engineering at a hypergrowth startup building mission-critical APIs.",
    },
    {
        "name": "Bhavna Joshi",
        "email": "bhavna.joshi@example.edu",
        "department": "Cloud Computing & Systems",
        "location": "Bhopal, Madhya Pradesh",
        "skills": ["AWS", "Terraform", "CI/CD", "Linux", "Docker", "Prometheus", "Kubernetes"],
        "interests": ["Infrastructure as Code", "Site Reliability Engineering", "DevSecOps"],
        "career_goals": "Manage resilient global cloud clusters with automated failover and zero downtime.",
    },
    {
        "name": "Sanjay Krishnan",
        "email": "sanjay.krishnan@example.edu",
        "department": "Electronics & Computer Science",
        "location": "Coimbatore, Tamil Nadu",
        "skills": ["Rust", "Actix-web", "WebAssembly", "SQLite", "C++", "Linux Systems"],
        "interests": ["Systems Programming", "Memory Safety", "High Performance WebAssembly"],
        "career_goals": "Develop secure, blazingly fast systems software powering the next generation of web engines.",
    },
    {
        "name": "Ritika Sen",
        "email": "ritika.sen@example.edu",
        "department": "Computer Science & Engineering",
        "location": "Kolkata, West Bengal",
        "skills": ["React", "Next.js", "TypeScript", "GraphQL", "PostgreSQL", "Node.js"],
        "interests": ["Full Stack Engineering", "Component Architecture", "API Federation"],
        "career_goals": "Build delightful, accessible consumer web platforms with modern frontend frameworks.",
    },

    # ── Flutter Mobile Developers (8) ──
    {
        "name": "Parth Prajapati",
        "email": "parth.prajapati@example.edu",
        "department": "Computer Science & Engineering",
        "location": "Ahmedabad, Gujarat",
        "skills": ["Flutter", "Dart", "BLoC", "Clean Architecture", "REST APIs", "CI/CD for Mobile"],
        "interests": ["Cross-Platform Mobile", "State Management", "Mobile Architecture"],
        "career_goals": "Chief Mobile Architect designing high-performance Flutter applications for fintech.",
    },
    {
        "name": "Kruti Patel",
        "email": "kruti.patel@example.edu",
        "department": "Information Technology",
        "location": "Surat, Gujarat",
        "skills": ["Flutter", "Dart", "Firebase", "Riverpod", "Offline-First Sync", "Push Notifications"],
        "interests": ["Consumer Mobile Apps", "Offline Caching", "Cloud Firestore Integration"],
        "career_goals": "Build mobile-first commerce applications used by millions across Tier 2 and Tier 3 cities.",
    },
    {
        "name": "Akash Bose",
        "email": "akash.bose@example.edu",
        "department": "Multimedia & Software Engineering",
        "location": "Kolkata, West Bengal",
        "skills": ["Flutter", "Dart", "Custom Painters", "Rive", "Figma to Flutter", "Mobile Animations"],
        "interests": ["Mobile UX Design", "Motion UI", "Fluid Micro-Interactions"],
        "career_goals": "Create world-class animated mobile experiences that redefine mobile design benchmarks.",
    },
    {
        "name": "Rahul Nair",
        "email": "rahul.nair@example.edu",
        "department": "Applied Electronics & Computing",
        "location": "Kochi, Kerala",
        "skills": ["Flutter", "Dart", "Bluetooth Low Energy (BLE)", "MQTT", "IoT Integration", "Android"],
        "interests": ["Smart Hardware Companion Apps", "Health Wearables", "Edge IoT"],
        "career_goals": "Develop companion mobile applications for wearable medical devices and smart IoT sensors.",
    },
    {
        "name": "Naveen Kumar",
        "email": "naveen.kumar@example.edu",
        "department": "Artificial Intelligence & Mobile Computing",
        "location": "Bengaluru, Karnataka",
        "skills": ["Flutter", "Dart", "TensorFlow Lite", "On-Device ML", "CameraX", "Computer Vision"],
        "interests": ["Mobile AI", "Real-Time Image Processing", "Privacy-Preserving Edge ML"],
        "career_goals": "Build privacy-first mobile apps that perform real-time AI inference without sending data to servers.",
    },
    {
        "name": "Simran Kaur",
        "email": "simran.kaur@example.edu",
        "department": "Computer Science & Engineering",
        "location": "Gurugram, Haryana",
        "skills": ["Flutter", "Dart", "Platform Channels", "Kotlin", "Swift", "Native iOS/Android Plugins"],
        "interests": ["Hybrid Mobile Architecture", "Native Bridge Interop", "SDK Development"],
        "career_goals": "Develop open-source Flutter plugins and core mobile SDKs for global developers.",
    },
    {
        "name": "Mihir Desai",
        "email": "mihir.desai@example.edu",
        "department": "Information & Communication Technology",
        "location": "Vadodara, Gujarat",
        "skills": ["Flutter", "Dart", "Biometric Auth", "Secure Enclave", "Payment Gateways", "BLoC"],
        "interests": ["Mobile Security", "FinTech Banking Apps", "Cryptographic Mobile Storage"],
        "career_goals": "Architect banking and neobank mobile applications adhering to RBI security standards.",
    },
    {
        "name": "Gaurav Mishra",
        "email": "gaurav.mishra@example.edu",
        "department": "Computer Applications",
        "location": "Varanasi, Uttar Pradesh",
        "skills": ["Flutter", "Dart", "Supabase", "PostgreSQL", "Real-Time Streams", "Provider"],
        "interests": ["Real-time Chat Apps", "Social Mobile Platforms", "Backend-as-a-Service"],
        "career_goals": "Build engaging social and student community mobile applications.",
    },
]


# ── Seed Opportunity Definitions (60 opportunities) ──────────────────────────
...
OPPORTUNITIES_SEED_DATA = [
    ...
    # ── Additional AI Background Opportunities (8) ──
    {
        "title": "India GenAI Agents Grand Challenge 2026",
        "description": "Construct autonomous multi-agent workflows using LangChain, AutoGen, and tool calling to solve enterprise automation and developer productivity problems.",
        "domain": "technology",
        "type": "hackathon",
        "eligibility": "Undergraduate and postgraduate students enrolled in recognized universities across India.",
        "deadline_days": 32,
        "location": "Bengaluru, Karnataka (Hybrid)",
        "organizer": "AI Builders Guild & TechHub Bengaluru",
        "source_url": "https://genaiagents.in/challenge",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹12,00,000", "max_team_size": 4, "format": "hybrid"},
    },
    {
        "title": "Smart Cities Computer Vision & Traffic Challenge",
        "description": "Deploy deep learning models (YOLO, OpenCV) to analyze CCTV feeds for real-time pothole detection, traffic congestion, and emergency vehicle routing.",
        "domain": "technology",
        "type": "hackathon",
        "eligibility": "Open to all engineering students. Dataset of 50,000 annotated municipal camera frames provided.",
        "deadline_days": 40,
        "location": "Surat, Gujarat",
        "organizer": "Surat Municipal Innovation Cell",
        "source_url": "https://suratsmartcity.gov.in/hackathon",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹6,00,000", "max_team_size": 4, "format": "in-person"},
    },
    {
        "title": "Healthcare AI & Clinical Diagnostics Hackathon",
        "description": "Develop predictive diagnostic models and LLM patient summaries using synthetic EHR and anonymized radiology imaging data.",
        "domain": "health",
        "type": "hackathon",
        "eligibility": "Teams of 2 to 4 students from computer science, biotechnology, or medical backgrounds.",
        "deadline_days": 26,
        "location": "Pune, Maharashtra",
        "organizer": "HealthTech Innovation Alliance",
        "source_url": "https://healthai-pune.dev",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹7,00,000", "max_team_size": 4, "format": "hybrid"},
    },
    {
        "title": "National Indic Language AI Hackathon",
        "description": "Build state-of-the-art translation, speech-to-text, and conversational assistants tailored for 22 scheduled Indian languages using Hugging Face and PyTorch.",
        "domain": "technology",
        "type": "hackathon",
        "eligibility": "Open to student developers, linguists, and researchers nationwide.",
        "deadline_days": 55,
        "location": "New Delhi",
        "organizer": "Digital India Bhashini Division",
        "source_url": "https://bhashini.gov.in/hackathon",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹15,00,000", "max_team_size": 4, "format": "hybrid"},
    },
    {
        "title": "Autonomous Robotics & Edge Vision Competition",
        "description": "Program warehouse mobile robots and autonomous delivery rovers using ROS 2, SLAM navigation, and edge vision models running on Jetson Orin.",
        "domain": "technology",
        "type": "competition",
        "eligibility": "B.Tech and M.Tech robotics and computer engineering students.",
        "deadline_days": 60,
        "location": "Ahmedabad, Gujarat",
        "organizer": "Gujarat Robotics Guild & IIT Gandhinagar",
        "source_url": "https://roboticsguild.in/competition",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹8,00,000", "max_team_size": 4, "format": "in-person"},
    },
    {
        "title": "Google Research India AI Fellowship 2026",
        "description": "12-month funded research fellowship paired with Google Research scientists working on foundation models, AI safety, and healthcare ML.",
        "domain": "science",
        "type": "fellowship",
        "eligibility": "Final-year undergraduate or postgraduate students with demonstrated research publications.",
        "deadline_days": 70,
        "location": "Bengaluru, Karnataka",
        "organizer": "Google Research India",
        "source_url": "https://research.google/fellowships/india",
        "is_event": False,
    },
    {
        "title": "Enterprise RAG & Vector Database Masterclass",
        "description": "Hands-on workshop building production RAG pipelines with pgvector, LangChain, semantic reranking, and evaluation frameworks.",
        "domain": "technology",
        "type": "workshop",
        "eligibility": "Students with intermediate Python skills.",
        "deadline_days": 18,
        "location": "Hyderabad, Telangana",
        "organizer": "Hyderabad AI Forum",
        "source_url": "https://hydai.org/rag-workshop",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"format": "hybrid", "sessions": 4, "certificate": True},
    },
    {
        "title": "Deep Learning & Computer Vision Bootcamp",
        "description": "Intensive masterclass on Vision Transformers (ViT), YOLO object detection, and model quantization for edge deployment.",
        "domain": "technology",
        "type": "workshop",
        "eligibility": "Engineering students interested in computer vision.",
        "deadline_days": 15,
        "location": "Kolkata, West Bengal",
        "organizer": "Bengal AI Network",
        "source_url": "https://bengalai.org/vision-bootcamp",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"format": "in-person", "sessions": 3, "certificate": True},
    },

    # ── Additional Web & Software Development Opportunities (9) ──
    {
        "title": "Full-Stack Web DevSprint 2026",
        "description": "36-hour sprint building high-performance modern web apps with Next.js 15, React Server Components, TypeScript, and Postgres.",
        "domain": "technology",
        "type": "hackathon",
        "eligibility": "Open to all enrolled college students.",
        "deadline_days": 21,
        "location": "Surat, Gujarat",
        "organizer": "Surat Web Developers Group",
        "source_url": "https://suratwebdev.in/devsprint",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹4,00,000", "max_team_size": 3, "format": "hybrid"},
    },
    {
        "title": "FinTech High-Frequency API & Systems Challenge",
        "description": "Design low-latency microservices, order matching engines, and real-time WebSocket feeds using Golang, Rust, and PostgreSQL.",
        "domain": "business",
        "type": "competition",
        "eligibility": "Engineering and CS students with strong systems programming knowledge.",
        "deadline_days": 35,
        "location": "Mumbai, Maharashtra",
        "organizer": "BSE & NSE FinTech Tech Alliance",
        "source_url": "https://fintechsystems.in/challenge",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹9,00,000", "max_team_size": 3, "format": "in-person"},
    },
    {
        "title": "SaaS Product Builder Hackathon",
        "description": "Ship a multi-tenant B2B micro-SaaS application with authentication, billing, dashboard metrics, and API integrations in 48 hours.",
        "domain": "business",
        "type": "hackathon",
        "eligibility": "Teams of student founders and builders.",
        "deadline_days": 28,
        "location": "Indore, Madhya Pradesh",
        "organizer": "Indore Tech Startups Guild",
        "source_url": "https://indoresaas.dev/hackathon",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹5,00,000", "max_team_size": 4, "format": "hybrid"},
    },
    {
        "title": "NextGen Cloud Infrastructure Internship 2026",
        "description": "Paid 12-week software engineering internship building Kubernetes automation controllers, Terraform modules, and CI/CD pipelines.",
        "domain": "technology",
        "type": "internship",
        "eligibility": "Third or final year CS/IT students.",
        "deadline_days": 45,
        "location": "Gurugram, Haryana",
        "organizer": "CloudScale Technologies",
        "source_url": "https://cloudscale.tech/internships",
        "is_event": False,
    },
    {
        "title": "Open Source Web Development Fellowship",
        "description": "Funded stipend fellowship contributing full-time to major open-source web ecosystems including Next.js, FastAPI, and Supabase.",
        "domain": "technology",
        "type": "fellowship",
        "eligibility": "Students with existing GitHub open source pull requests.",
        "deadline_days": 50,
        "location": "Jaipur, Rajasthan",
        "organizer": "India FOSS Foundation",
        "source_url": "https://indiafoss.org/fellowship",
        "is_event": False,
    },
    {
        "title": "Distributed Systems & Kafka Engineering Workshop",
        "description": "Architect event-driven systems with Apache Kafka, message serialization (Protobuf/Avro), and partitioned consumer groups.",
        "domain": "technology",
        "type": "workshop",
        "eligibility": "Engineering students interested in backend architecture.",
        "deadline_days": 14,
        "location": "Pune, Maharashtra",
        "organizer": "Pune Java & Distributed Systems Group",
        "source_url": "https://punesystems.org/kafka-workshop",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"format": "in-person", "sessions": 2, "certificate": True},
    },
    {
        "title": "Creative 3D Web & Three.js Masterclass",
        "description": "Build immersive 3D web interfaces, WebGL shaders, and smooth camera transitions using Three.js and React Three Fiber.",
        "domain": "arts",
        "type": "workshop",
        "eligibility": "Frontend developers and UI designers.",
        "deadline_days": 12,
        "location": "Chandigarh",
        "organizer": "Creative Coders India",
        "source_url": "https://creativecoders.in/threejs",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"format": "online", "sessions": 3, "certificate": True},
    },
    {
        ...
        "description": "Master asynchronous networking, connection pooling, background tasks with Celery/Redis, and FastAPI high-concurrency patterns.",
        "domain": "technology",
        "type": "workshop",
        "eligibility": "Students with Python fundamentals.",
        "deadline_days": 20,
        "location": "Lucknow, Uttar Pradesh",
        "organizer": "UP Python Developers Community",
        "source_url": "https://uppython.org/async-masterclass",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"format": "hybrid", "sessions": 2, "certificate": True},
    },
    {
        "title": "Rust for High-Performance Systems Grant",
        "description": "Student grant for building high-speed networking, WebAssembly runtimes, or database engines written in Rust.",
        "domain": "technology",
        "type": "grant",
        "eligibility": "Undergraduate students submitting a GitHub prototype proposal.",
        "deadline_days": 65,
        "location": "Coimbatore, Tamil Nadu",
        "organizer": "Rust India Foundation",
        "source_url": "https://rustindia.dev/grants",
        "is_event": False,
    },

    # ── Additional Flutter Mobile Opportunities (8) ──
    {
        "title": "Flutter Forward India Hackathon 2026",
        "description": "Build high-performance, cross-platform Android and iOS mobile applications using Flutter 3, Dart, and clean state management.",
        "domain": "technology",
        "type": "hackathon",
        "eligibility": "Open to all university students across India.",
        "deadline_days": 30,
        "location": "Ahmedabad, Gujarat (Hybrid)",
        "organizer": "Google Developer Group (GDG) Ahmedabad",
        "source_url": "https://gdgahmedabad.com/flutter-forward",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹5,00,000", "max_team_size": 3, "format": "hybrid"},
    },
    {
        "title": "MobileFirst Retail & Offline-Sync Challenge",
        "description": "Create offline-first mobile POS and inventory apps for merchants using Flutter, SQLite/Isar, and background sync.",
        "domain": "business",
        "type": "hackathon",
        "eligibility": "College students with Flutter experience.",
        "deadline_days": 36,
        "location": "Surat, Gujarat",
        "organizer": "Gujarat Mobile Innovators Hub",
        "source_url": "https://mobilefirst-surat.dev",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹4,50,000", "max_team_size": 3, "format": "in-person"},
    },
    {
        "title": "Flutter & Firebase Mobile Engineering Internship",
        "description": "Paid 12-week mobile engineering internship building consumer Flutter apps with real-time Firebase, Cloud Firestore, and push notifications.",
        "domain": "technology",
        "type": "internship",
        "eligibility": "Penultimate or final-year engineering students with published Flutter apps.",
        "deadline_days": 42,
        "location": "Bengaluru, Karnataka",
        "organizer": "AppVantage Mobile Studios",
        "source_url": "https://appvantage.io/careers/internships",
        "is_event": False,
    },
    {
        "title": "HealthTech Telemedicine Flutter App Challenge",
        "description": "Engineer patient vital-sign logging, encrypted prescription sharing, and doctor consultation features in a Flutter mobile app.",
        "domain": "health",
        "type": "competition",
        "eligibility": "Undergraduate and postgraduate students in CS, IT, or biomedical computing.",
        "deadline_days": 45,
        "location": "Kochi, Kerala",
        "organizer": "Kerala HealthTech Mission",
        "source_url": "https://keralahealthtech.in/flutter-challenge",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹6,00,000", "max_team_size": 4, "format": "hybrid"},
    },
    {
        "title": "FinTech Mobile Banking Flutter Challenge",
        "description": "Build next-generation mobile banking experiences using Flutter, biometric authentication, secure hardware keystore, and payment flows.",
        "domain": "business",
        "type": "hackathon",
        "eligibility": "Enrolled college students with mobile development portfolios.",
        "deadline_days": 24,
        "location": "Mumbai, Maharashtra",
        "organizer": "Digital Banking Guild India",
        "source_url": "https://digitalbankingguild.in/flutter",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹7,50,000", "max_team_size": 4, "format": "hybrid"},
    },
    {
        "title": "On-Device ML & Mobile Vision with Flutter",
        "description": "Hackathon focused on running on-device TensorFlow Lite and MobileNet models inside Flutter apps for offline object detection.",
        "domain": "technology",
        "type": "hackathon",
        "eligibility": "Students interested in mobile AI.",
        "deadline_days": 38,
        "location": "Hyderabad, Telangana",
        "organizer": "Mobile AI Labs India",
        "source_url": "https://mobileailabs.dev/hackathon",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"prize_pool": "₹5,00,000", "max_team_size": 3, "format": "hybrid"},
    },
    {
        "title": "Flutter BLoC & Clean Architecture Masterclass",
        "description": "Hands-on workshop teaching production state management with BLoC 8+, repository pattern, dependency injection with GetIt, and automated testing.",
        "domain": "technology",
        "type": "workshop",
        "eligibility": "Mobile developers with basic Flutter knowledge.",
        "deadline_days": 11,
        "location": "Noida, Uttar Pradesh",
        "organizer": "Delhi-NCR Flutter Community",
        "source_url": "https://flutterncr.dev/bloc-masterclass",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"format": "online", "sessions": 3, "certificate": True},
    },
    {
        "title": "Supabase & Flutter Real-Time App Bootcamp",
        "description": "Build real-time chat, authenticated profile sync, and file storage apps using Flutter and Supabase PostgreSQL backend.",
        "domain": "technology",
        "type": "workshop",
        "eligibility": "Open to all students.",
        "deadline_days": 16,
        "location": "Bhopal, Madhya Pradesh",
        "organizer": "Madhya Pradesh Developer Community",
        "source_url": "https://mpdevs.in/flutter-supabase",
        "is_event": True,
        "event_status": "open",
        "extra_details": {"format": "hybrid", "sessions": 2, "certificate": True},
    },
